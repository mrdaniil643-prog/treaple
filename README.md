...
**[Самостоятельная версия](app/)** — с регистрацией по почте и паролю,
несколькими магазинами и правами на уровне строк базы. Ставится на свой
хостинг, от Claude не зависит.
