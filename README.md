...
**[Как выглядит приложение](docs/SCREENSHOTS.md)** — скриншоты обновляются
автоматически на каждой сборке.

**[Веб-версия](web/)** — то же приложение страницей, работает с телефона без
Xcode и без платного аккаунта разработчика.
